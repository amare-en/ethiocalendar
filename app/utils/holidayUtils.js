...
export function getHolidaysForYear(etYear) {
  ...
  const fixedHolidays = [
    { title: { am: 'አዲስ ዓመት', en: 'Ethiopian New Year' }, date: { month: 1, day: 1 }, category: 'National', description: 'Marks the beginning of the Ethiopian calendar year.' },
    { title: { am: 'መስቀል', en: 'Finding of the True Cross' }, date: { month: 1, day: 17 }, category: 'Religious', description: 'Commemorates the finding of the True Cross.' },
    { title: { am: 'የገና በዓል', en: 'Ethiopian Christmas' }, date: { month: 4, day: 29 }, category: 'Religious', description: 'Celebrates the birth of Jesus Christ.' },
    { title: { am: 'ጥምቀት', en: 'Epiphany' }, date: { month: 5, day: 11 }, category: 'Religious', description: 'Celebrates the baptism of Jesus.' },
    { title: { am: 'የአድዋ ድል በዓል', en: 'Adwa Victory Day' }, date: { month: 6, day: 23 }, category: 'National', description: 'Commemorates the Battle of Adwa.' },
    { title: { am: 'ዓለም አቀፍ የሠራተኞች ቀን', en: 'International Labor Day' }, date: { month: 8, day: 23 }, category: 'National', description: 'Celebrates workers achievements.' },
    { title: { am: 'የአርበኞች ቀን', en: 'Patriots\' Victory Day' }, date: { month: 8, day: 27 }, category: 'National', description: 'Commemorates the end of Italian occupation.' },
    { title: { am: 'የደርግ መውደቅ', en: 'Downfall of the Derg' }, date: { month: 9, day: 20 }, category: 'National', description: 'Marks the end of the Derg regime.' },
  ];
  ...
  if (easterEthiopian[0] === etYear) {
      ...
      holidays.push({
        title: { am: 'ስቅለት', en: 'Good Friday' }, category: 'Religious', description: 'Commemorates the crucifixion of Jesus.',
      ...
      holidays.push({
        title: { am: 'ፋሲካ', en: 'Easter' }, category: 'Religious', description: 'Celebrates the resurrection of Jesus.',
