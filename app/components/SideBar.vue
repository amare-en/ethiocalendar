...
const menuItems = [
  { title: 'Home', link: '/', icon: 'mdi-home-variant-outline' },
  { title: 'Ethiopian Calendar', link: '/Ethiopia-Calendar', icon: 'mdi-calendar-month-outline' },
  { title: 'Calendar Converter', link: '/converter', icon: 'mdi-swap-horizontal-bold' },
