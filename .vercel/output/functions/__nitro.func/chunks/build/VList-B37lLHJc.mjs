import { toRef, shallowRef, ref, createVNode, normalizeStyle, normalizeClass, computed, watch, withDirectives, mergeProps, createElementVNode, Fragment, toDisplayString, toRaw, provide, inject, toValue, watchEffect, vShow } from 'vue';
import { d as VExpandTransition } from './index-BsXMJvGl.mjs';
import { u as useDimension, c as useRender, m as makeTagProps, d as makeDimensionProps, e as makeComponentProps } from './VRow-DuOE5lZP.mjs';
import { e as genericComponent, p as propsFactory, s as provideTheme, v as provideDefaults, L as deprecate, o as makeThemeProps, M as EventProp, I as IconValue, E as useProxiedModel, g as getCurrentInstance, R as focusChild, N as isPrimitive, J as consoleError, K as defineComponent, O as pick, C as deepEqual, P as getPropertyFromItem, Q as omit, F as wrapInArray } from './server.mjs';
import { u as useSsrBoot } from './ssrBoot-ZQn7gOuX.mjs';
import { M as MaybeTransition } from './index-DsqekkR1.mjs';
import { u as useElevation, a as useRounded, R as Ripple, V as VDefaultsProvider, m as makeRoundedProps, b as makeElevationProps } from './index-CaPUijDs.mjs';
import { c as createSimpleFunctional } from './createSimpleFunctional-Cf07O5xJ.mjs';
import { u as useBorder, d as useDensity, e as useLink, c as useVariant, g as genOverlays, a as makeVariantProps, b as makeDensityProps, m as makeBorderProps, f as makeRouterProps } from './router-D8sdwdYd.mjs';
import { V as VAvatar } from './VAvatar-gjgzi8JG.mjs';
import { V as VIcon } from './VIcon-xAIaYZjS.mjs';
import { u as useBackgroundColor, a as useTextColor } from './color-DbIj6V-T.mjs';
...
export { VList as V, VListItem as a, VListItemTitle as b, VListSubheader as c, makeItemsProps as m, useItems as u };
//# sourceMappingURL=VList-B37lLHJc.mjs.map
