import { toRef, computed, withDirectives, createVNode, mergeProps, createElementVNode, vShow, Fragment, toDisplayString, ref, watch, Teleport, Transition, inject, reactive, provide, shallowRef, toValue, onScopeDispose, toRaw, watchEffect, readonly, nextTick, normalizeStyle, normalizeClass } from 'vue';
import { a as animate, g as getTargetBox, n as nullifyTransforms, B as Box, b as getElementBox, c as getOverflow } from './animation-APx-zXWD.mjs';
import { e as genericComponent, p as propsFactory, U as useLocale, s as provideTheme, E as useProxiedModel, o as makeThemeProps, M as EventProp, I as IconValue, g as getCurrentInstance, f as useRtl, a7 as useToggleScope, d as convertToUnit, t as templateRef, ac as acceleratedEasing, ae as standardEasing, ad as deceleratedEasing, ab as matchesSelector, j as destructComputed, ag as CircularBuffer, C as deepEqual, J as consoleError, w as clamp, ah as defer, a0 as makeDisplayProps, V as useDisplay, af as useGoTo, v as provideDefaults, a5 as focusableChildren } from './server.mjs';
import { V as VExpandXTransition, a as VFadeTransition } from './index-BsXMJvGl.mjs';
import { m as makeTagProps, e as makeComponentProps, u as useDimension, c as useRender, d as makeDimensionProps } from './VRow-DuOE5lZP.mjs';
import { u as useGroupItem, m as makeGroupItemProps, a as makeGroupProps, b as useGroup } from './group-CNE9VaDa.mjs';
...
import { u as useBorder, d as useDensity, e as useLink, c as useVariant, g as genOverlays, a as makeVariantProps, f as makeRouterProps, b as makeDensityProps, m as makeBorderProps, h as useRouter } from './router-D8sdwdYd.mjs';
...
import { p as parseAnchor, f as flipSide, e as flipAlign, g as flipCorner, h as getAxis } from './position-kce-9oVv.mjs';
...
export { VChip as V, VDialogTransition as a, VMenuSymbol as b, VOverlay as c, makeVOverlayProps as m, useScopeId as u };
//# sourceMappingURL=VOverlay-CWEBiN_D.mjs.map
