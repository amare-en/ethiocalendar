import { ref, computed, shallowRef, toRef, watch, createVNode, mergeProps, createElementVNode, Fragment, createTextVNode, normalizeStyle, normalizeClass, useId, inject, provide, onScopeDispose, nextTick, watchEffect } from 'vue';
...
import { c as useRender, u as useDimension, m as makeTagProps, d as makeDimensionProps, e as makeComponentProps } from './VRow-DuOE5lZP.mjs';
import { c as useVariant, d as useDensity, g as genOverlays, a as makeVariantProps, b as makeDensityProps } from './router-D8sdwdYd.mjs';
import { V as VDefaultsProvider, u as useElevation, a as useRounded, m as makeRoundedProps, b as makeElevationProps } from './index-CaPUijDs.mjs';
import { e as genericComponent, p as propsFactory, U as useLocale, E as useProxiedModel, F as wrapInArray, C as deepEqual, a8 as camelizeProps, a9 as ensureValidVNode, s as provideTheme, Q as omit, aa as checkPrintable, ab as matchesSelector, f as useRtl, a3 as isClickInsideElement, g as getCurrentInstance, a7 as useToggleScope, d as convertToUnit, o as makeThemeProps, I as IconValue, R as focusChild, a4 as getNextElement, a5 as focusableChildren, V as useDisplay, a6 as debounce, w as clamp, P as getPropertyFromItem } from './server.mjs';
import { u as useLocation, a as usePosition, m as makePositionProps, b as makeLocationProps } from './position-kce-9oVv.mjs';
import { V as VIcon } from './VIcon-xAIaYZjS.mjs';
import { V as VBtn, u as useResizeObserver } from './VBtn-CtUSWaMx.mjs';
import { V as VTextField, m as makeVTextFieldProps } from './VTextField-Ba7jKIdM.mjs';
import { u as useForm } from './VInput-B9fom_-l.mjs';
import { f as forwardRefs } from './forwardRefs-CtBGLcOj.mjs';
import { u as useItems, V as VList, a as VListItem, c as VListSubheader, m as makeItemsProps } from './VList-B37lLHJc.mjs';
import { m as makeTransitionProps } from './index-DsqekkR1.mjs';
import { V as VChip, a as VDialogTransition, u as useScopeId, b as VMenuSymbol, c as VOverlay, m as makeVOverlayProps } from './VOverlay-CWEBiN_D.mjs';
...
export { VSelect as V, VAlert as a, VCheckboxBtn as b };
//# sourceMappingURL=VSelect-A5-TMnCd.mjs.map
