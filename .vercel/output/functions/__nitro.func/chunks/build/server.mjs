import { capitalize, ref, computed, toRaw, warn, inject as inject$1, toRef, watch, onScopeDispose, camelize, isVNode, Comment, Fragment, defineComponent as defineComponent$1, getCurrentInstance as getCurrentInstance$1, reactive, watchEffect, toValue, provide, shallowRef, unref, effectScope, createVNode, mergeProps, createElementVNode, hasInjectionContext, normalizeClass, defineAsyncComponent, h, shallowReactive, Suspense, createApp, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isRef, isShallow, isReactive, getCurrentScope, withCtx, toRefs, nextTick, useSSRContext } from 'vue';
import { e as createError$1, i as hasProtocol, k as isScriptProtocol, l as joinURL, w as withQuery, s as sanitizeStatusCode, m as getContext, $ as $fetch, n as createHooks, o as executeAsync, q as toRouteMatcher, r as createRouter$1, v as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "Blog",
    path: "/Blog",
    component: () => import('./Blog-CdW62zSf.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D-_SgbTE.mjs')
  },
  {
    name: "Easter",
    path: "/Easter",
    component: () => import('./Easter-CK8aRJDK.mjs')
  },
  {
    name: "NewYear",
    path: "/NewYear",
    component: () => import('./NewYear-8Z4KRGqO.mjs')
  },
  {
    name: "About-Us",
    path: "/About-Us",
    component: () => import('./About-Us-CrSRT1X7.mjs')
  },
  {
    name: "Holidays",
    path: "/Holidays",
    component: () => import('./Holidays-CNdf6ZxU.mjs')
  },
  {
    name: "Converter",
    path: "/Converter",
    component: () => import('./Converter-BL5CmVvY.mjs')
  },
  {
    name: "holidayet",
    path: "/holidayet",
    component: () => import('./holidayet-C1UAtsaN.mjs')
  },
  {
    name: "Contact-Us",
    path: "/Contact-Us",
    component: () => import('./Contact-Us-C2QJMikJ.mjs')
  },
  {
    name: "GoodFriday",
    path: "/GoodFriday",
    component: () => import('./GoodFriday-HZa1KRr4.mjs')
  },
  {
    name: "holidayUtils",
    path: "/holidayUtils",
    component: () => import('./holidayUtils-CMrDxyZ4.mjs')
  },
  {
    name: "Ethiopia-Time",
    path: "/Ethiopia-Time",
    component: () => import('./Ethiopia-Time-D-PL-y4n.mjs')
  },
  {
    name: "AdwaVictoryDay",
    path: "/AdwaVictoryDay",
    component: () => import('./AdwaVictoryDay-m4IJCXhx.mjs')
  },
  {
    name: "Privacy-Policy",
    path: "/Privacy-Policy",
    component: () => import('./Privacy-Policy-7strmp5q.mjs')
  },
  {
    name: "EthiopiaEpiphany",
    path: "/EthiopiaEpiphany",
    component: () => import('./EthiopiaEpiphany-BHd3barh.mjs')
  },
  {
    name: "Terms-Conditions",
    path: "/Terms-Conditions",
    component: () => import('./Terms-Conditions-BPHgKS1t.mjs')
  },
  {
    name: "Ethiopia-Calendar",
    path: "/Ethiopia-Calendar",
    component: () => import('./Ethiopia-Calendar-bfaotuPD.mjs')
  },
  {
    name: "EthiopiaChristmas",
    path: "/EthiopiaChristmas",
    component: () => import('./EthiopiaChristmas-D8EIhC5N.mjs')
  },
  {
    name: "Current-Ethiopia-Date",
    path: "/Current-Ethiopia-Date",
    component: () => import('./Current-Ethiopia-Date-CEN4lNqz.mjs')
  },
  {
    name: "FindingOfTheTrueCross",
    path: "/FindingOfTheTrueCross",
    component: () => import('./FindingOfTheTrueCross-Cy43gi0d.mjs')
  },
  {
    name: "InternationalLaborDay",
    path: "/InternationalLaborDay",
    component: () => import('./InternationalLaborDay-3WKLvg21.mjs')
  },
  {
    name: "About-Ethiopian-Calendar",
    path: "/About-Ethiopian-Calendar",
    component: () => import('./About-Ethiopian-Calendar-CtAT9bS2.mjs')
  },
  {
    name: "Ethiopian-Calendar-Facts",
    path: "/Ethiopian-Calendar-Facts",
    component: () => import('./Ethiopian-Calendar-Facts-DgczZJcb.mjs')
  }
];
...
function vuetifyConfiguration() {
  const options = { "theme": { "defaultTheme": "light", "themes": { "light": { "colors": { "primary": "#23629F", "secondary": "#5CBBF6", "accent": "#C01867", "error": "#FF5252" } } } }, "ssr": true };
  return options;
}
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CpZaYd1v.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-K3pUn6Hp.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DklxpaCN.mjs'));
...
export { isEmpty as $, getForeground as A, hasEvent as B, deepEqual as C, isObject as D, useProxiedModel as E, wrapInArray as F, consoleWarn as G, findChildrenWithProvide as H, IconValue as I, consoleError as J, defineComponent as K, deprecate as L, EventProp as M, isPrimitive as N, pick as O, getPropertyFromItem as P, omit as Q, focusChild as R, onlyDefinedProps as S, isOn as T, useLocale as U, useDisplay as V, createRange as W, keyValues as X, defineFunctionalComponent as Y, getObjectValueByPath as Z, _export_sfc as _, useRouter as a, makeDisplayProps as a0, asyncDataDefaults as a1, createError as a2, isClickInsideElement as a3, getNextElement as a4, focusableChildren as a5, debounce as a6, useToggleScope as a7, camelizeProps as a8, ensureValidVNode as a9, checkPrintable as aa, matchesSelector as ab, acceleratedEasing as ac, deceleratedEasing as ad, standardEasing as ae, useGoTo as af, CircularBuffer as ag, defer as ah, filterInputAttrs as ai, callEvent as aj, IN_BROWSER as ak, useRuntimeConfig as b, nuxtLinkDefaults as c, convertToUnit as d, entry$1 as default, genericComponent as e, useRtl as f, getCurrentInstance as g, breakpoints as h, getCurrentInstanceName as i, destructComputed as j, includes as k, useTheme as l, useIcon as m, navigateTo as n, makeThemeProps as o, propsFactory as p, flattenFragments as q, resolveRouteObject as r, provideTheme as s, templateRef as t, useNuxtApp as u, provideDefaults as v, clamp as w, isCssColor as x, isParsableColor as y, parseColor as z };
