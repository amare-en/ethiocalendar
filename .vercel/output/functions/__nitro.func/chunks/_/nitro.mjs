...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "d5f37fc6-148e-4553-b0e9-eb93094b0e22",
...
const _lazy_PezHKj = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_PezHKj, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_PezHKj, lazy: true, middleware: false, method: undefined }
];
